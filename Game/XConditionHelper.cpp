...
bool XConditionHelper::Talent_Style_TP( CSCondition_Leaf* pCondition, wstring& strText )
{
	...
	switch (nTalentStyle)
	{
	case TALENT_STYLE_DEFENDER:	style = XGetStr(L"TALENT_STYLE_DEFENDER");	break;
	case TALENT_STYLE_BERSERKER:	style = XGetStr(L"TALENT_STYLE_BESERKER");	break;
	case TALENT_STYLE_ASSASSIN:	style = XGetStr(L"TALENT_STYLE_ASSASSIN");	break;
	case TALENT_STYLE_RANGER:		style = XGetStr(L"TALENT_STYLE_RANGER");	break;
	case TALENT_STYLE_SORCERER:	style = XGetStr(L"TALENT_STYLE_SORCERER");	break;
	case TALENT_STYLE_CLERIC:		style = XGetStr(L"TALENT_STYLE_CLERIC");	break;
	default:	return false;
	}
