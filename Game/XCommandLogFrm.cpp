...
: mint3::MTextFrame(szName, pParent, pListener), m_bLogging(true)
{
	...
	m_CmdLogger.Init(MLogLevel::MLOG_LEVEL_DEBUG, nOutputFlags, "mlog_command.txt",NULL, MLocale::ConvUTF16ToAnsi(XPath::GetMyDocumentsRaiderzSubPath(PATH_MYDOC_SAVE).c_str()).c_str());
}
