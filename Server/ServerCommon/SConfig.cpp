...
int				SConfig::m_nLogLevel = static_cast<int>(MLogLevel::MLOG_LEVEL_INFORMATION);
...
void SConfig::Init_INI_Common(const wchar_t* szFileName)
{
	...
	m_nLogLevel = GetPrivateProfileInt(CONFIG_TOKEN_APP_LOG,	L"LOG_LEVEL", static_cast<int>(MLogLevel::MLOG_LEVEL_INFORMATION),	szFileName);
