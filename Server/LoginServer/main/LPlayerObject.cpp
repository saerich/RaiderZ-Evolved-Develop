...
, m_nState(PlayerObjectState::POS_WAITING_FOR_LOGIN)
...
{
	m_nState = PlayerObjectState::POS_SELECT_CHAR;
	m_nSelectedCharIndex = -1;
}

void LPlayerObject::OnLoginGameServer(int nCharIndex)
{
	m_nState = PlayerObjectState::POS_LOGIN_GAME_SERVER;
	m_nSelectedCharIndex = nCharIndex;
}

void LPlayerObject::OnMoveServer()
{
	m_nState = PlayerObjectState::POS_MOVE_SERVER;
}
