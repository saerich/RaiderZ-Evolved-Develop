...
void ZServerInfoDumper::Dump(wstring strPlayerName)
{
	...
	m_Logger.Init(MLogLevel::MLOG_LEVEL_DEBUG, MLOG_FILE, MLocale::ConvUTF16ToAnsi(strFileName.c_str()).c_str(), NULL, NULL);
...
void ZServerInfoDumper::Log( const wchar_t* pFormat, ... )
{
	...
	m_Logger.Output(buf, MLogLevel::MLOG_LEVEL_INFORMATION);
