...
void GApplication::OutputLog(const wchar_t* szText, MLogLevel nLevel)
{
	...
	switch (nLevel)
	{
	case MLogLevel::MLOG_LEVEL_DEBUG:		GApplication::GetInstance().AddLogString(strText.c_str(), RGB(130, 130, 130)); break;
	case MLogLevel::MLOG_LEVEL_INFORMATION:	GApplication::GetInstance().AddLogString(strText.c_str()); break;
	case MLogLevel::MLOG_LEVEL_WARNING:		GApplication::GetInstance().AddLogString(strText.c_str(), RGB(0, 0, 255)); break;
