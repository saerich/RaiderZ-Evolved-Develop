...
bool GLoginLogic::LoginGameServer(MUID uidPlayer, MUID uidConnectionKey/*, bool bOnPmang, wstring strPmangStatIndex*/, int nPCCafeID)
{
...
bool GLoginLogic::MoveGameServer(MUID uidPlayerSession, MUID uidConnectionKey/*, bool bOnPmang, wstring strPmangStatIndex*/, int nPCCafeID)
{
