...
string GAIMonitorPort::ExtractGLogForXML( MLogLevel nLevel, const char* temp )
{
	MXml xml;
	MXmlDocument* root = xml.Doc();
	MXmlElement* pNew = new MXmlElement("Log");
	...
	switch (nLevel)
	{
	case MLogLevel::MLOG_LEVEL_DEBUG:		strLevel = "GLogD";	break;
	case MLogLevel::MLOG_LEVEL_INFORMATION:	strLevel = "GLogI";	break;
	case MLogLevel::MLOG_LEVEL_WARNING:		strLevel = "GLogW";	break;
	case MLogLevel::MLOG_LEVEL_ERROR:		strLevel = "GLogE";	break;
	}
...
void GAIMonitorPort::SendGameLogToViewer( MLogLevel nLevel, const char* temp )
{
