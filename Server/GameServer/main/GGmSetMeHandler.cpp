...
void GGmSetMeHandler::Talent( GEntityPlayer* pPlayer, wstring strTalent )
{
	...
	if (strTalent == L"all")
	{
		gmgr.pTalentInfoMgr->GetStyleTalentID(TALENT_STYLE_DEFENDER, vecTalentID);
		gmgr.pTalentInfoMgr->GetStyleTalentID(TALENT_STYLE_BERSERKER, vecTalentID);
		gmgr.pTalentInfoMgr->GetStyleTalentID(TALENT_STYLE_CLERIC, vecTalentID);
	}
	...
	{
		gmgr.pTalentInfoMgr->GetStyleTalentID(TALENT_STYLE_LICENSE, vecTalentID);
	}
