...
bool GLoginLogicMoveGameServer::Apply(/*bool bOnPmang, wstring strPmangStatIndex*/)
{
...
void GLoginLogicMoveGameServer::NewLazyLoginMoveGameServerTask(/*bool bOnPmang, wstring strPmangStatIndex*/)
{
