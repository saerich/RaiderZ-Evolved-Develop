...
void GASyncTask_LazyLoginMoveGameServer::Init(MUID uidPlayerSession, MUID uidConnectionKey, MUID uidRealPlayerUID/*, bool bOnPmang, wstring strPmangStatIndex*/)
{
