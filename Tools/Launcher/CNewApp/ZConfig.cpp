...
bool	ZConfig::m_bHideWebPage = false;
string	ZConfig::m_strWebPageURL = "";

bool	ZConfig::m_bStaticLaunch = false;
string	ZConfig::m_strStaticServerName = "";
string	ZConfig::m_strStaticIPAddress = "";
bool	ZConfig::m_bSkipSelectWorldForPWE = false;

bool	ZConfig::m_bSkipUpdate = false;
