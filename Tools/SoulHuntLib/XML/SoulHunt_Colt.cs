...
namespace SoulHunt
{
    ...
    #region SHColtSection - 각 섹션의 Parent
    ...
    #region SHColtCombatSection - 가장 핵심이 되는 섹션
    [Serializable]
    ...
    #region COMBAT 섹션을 제외한 모든 섹션들의 정의 - SHColtEventSection/SHColtAggroSection/SHColtIdleSection/SHColtReactionSection/SHColtStressSection/SHColtVictorySection
    ...
    #region ACTION 정의(Embedded Action List까지 지원한다.)
    ...
    #region SHColtDefClause - DEFAULT 절(Clause)에 대한 정의
    [Serializable]
