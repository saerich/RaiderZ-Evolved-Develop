...
//	nEtcKinds.push_back(FILENAME_AND_DESC(".lightmap", "오브젝트의 라이트맵"));
	nEtcKinds.push_back(FILENAME_AND_DESC("_lightmap", "static-mesh의 라이트맵"));
	nEtcKinds.push_back(FILENAME_AND_DESC("_light", "지형의 라이트맵"));
	nEtcKinds.push_back(FILENAME_AND_DESC("", "그 외"));
